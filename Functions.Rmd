...
result <- filter_function(data_behave, "Donor", "Touching", "R1", "Touching", "Ball")
...
result <- duration_function(result, subject_1 = "Donor", subject_1_behave = "Touching", subject_2 = "R1", subject_2_behave = "Touching", modifier = "Ball")
