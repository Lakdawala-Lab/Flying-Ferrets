...
filter_function <- function(data, subject_1 = "Donor", subject_1_behave, subject_2, subject_2_behave, modifier) {
  # Find the first instance when subject_1 behaves with the modifier
  first_instance <- which(data$Subject == subject_1 & data$Behavior == subject_1_behave & data$Modifier == modifier)[1]

  # Filter the data to keep every data after the first instance
  filtered_data <- data[first_instance:nrow(data),]
  ...
  for (i in 1:nrow(filtered_data)) {
    ...
    # If the current row is an observation of subject_1, add it to the result
    ...
    # If the current row is an observation of subject_2, add it to the result
